...
# rmr
a dependency for removing things with rm -r
This is in another repo.  I wonder how I can use that rather than have a hard link locally...

# chaptersplit, opusduration, mediaduration
